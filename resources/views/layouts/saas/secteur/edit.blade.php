...
<div class="page-meta">
	<nav class="breadcrumb-style-one" aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item" aria-current="page"><a href="{{route('Secteur.index')}}">Secteur</a></li>
		...
		<div class="statbox widget ">
			<div class="widget-header">                                
				<div class="row">
					...
					<center>   <h4>Formulaire de Modification d'une Secteur</h4> </center> 
					</div>                                                                        
				</div>
			</div>
              ...
              <div class="row mb-3">
                <div class="col-md-12">
                  ...
                  <textarea class="form-control"
                            name="detail" 
                            rows="3" 
                            id="textareaDefault">{{$Secteur->detail}}
                  </textarea>
                </div>
              </div>     
