...
<header class="page-header">
	...
	<div class="right-wrapper pull-right">
		<ol class="breadcrumbs">
			...
			<li><a href="#"><span>Ajouter un dépot</span></a></li>
		...
		@csrf	
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Formulaire d'ajout de dépot</h2>
					<h2 class="text-black">
				...
				<div class="panel-body">
					<div class="form-group">
						<label class="col-sm-3 control-label">Entrer nom du depositaire 
						...
						<div class="col-sm-9">
							<div class="input-group">
								...
								<input type="text" 
										name="nom" 
										class="form-control"
										placeholder="Entrer nom du depositaire" 
										required 
								/>
							</div>
						</div>
