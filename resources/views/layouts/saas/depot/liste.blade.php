...
<div class="row">
  <div class="col-md-12">
    ...
    <h2 class="text-black">
			<a href="{{route('depot.create')}}" style="text-align:right; float:right; margin-bottom:20px;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">
              ...
              <td class="text-center">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1"> 
                    <a class="dropdown-item" href="{{route('depot.edit', $depot -> id)}}">Editer</a>
                  </div>
                </div>
              </td>
            </tr>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h4 class="modal-title" id="myCenterModalLabel">Formulaire d'ajout d'entrée caisse</h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" 
                          ...
                          placeholder="Saisir le nom du dépositaire" 
                          required>
                  <div class="valid-feedback">Looks good!</div>
                </div>
                <div class="col-md-6">
                  <label for="validationCustom01" class="form-label">Montant encaissé</label>
                  <input type="text" 
                          name="caisse"  
                          class="form-control" 
                          id="validationCustom01" 
                          placeholder="Saisir le mmontant encaissé" 
                          required>
                  <div class="valid-feedback">Looks good!</div>
                </div>
              </div>  
