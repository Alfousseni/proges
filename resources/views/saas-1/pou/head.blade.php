<meta charset="utf-8">
    ...
    <title>PROGES-PME | Progiciel de Gestion des Processus Métiers</title>
    ...
    <link rel="stylesheet" href="{{ asset('saas/src/plugins/dropify.min.css') }}">


    <link rel="stylesheet" href="{{asset('saas/src/plugins/src/font-icons/fontawesome/css/regular.css')}}">
    <link rel="stylesheet" href="{{asset('saas/src/plugins/src/font-icons/fontawesome/css/fontawesome.css')}}">
    
      <link href="{{asset('saas/src/assets/css/light/components/font-icons.css')}}" rel="stylesheet" type="text/css">
    
     <link href="{{asset('saas/src/assets/css/dark/components/font-icons.css')}}" rel="stylesheet" type="text/css">
    
       <!--  BEGIN CUSTOM STYLE FILE  -->
   <link href="{{asset('saas/src/assets/css/light/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('saas/src/assets/css/light/components/carousel.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('saas/src/assets/css/light/components/modal.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('saas/src/assets/css/light/components/tabs.css')}}" rel="stylesheet" type="text/css">
    ...
    <!--  END CUSTOM STYLE FILE  -->
     ...
     <link rel="stylesheet" type="text/css" href="{{asset('saas/src/plugins/src/vanillaSelectBox/vanillaSelectBox.css')}}">
    
     <link rel="stylesheet" type="text/css" href="{{asset('saas/src/plugins/css/light/vanillaSelectBox/custom-vanillaSelectBox.css')}}">

     <link rel="stylesheet" type="text/css" href="{{asset('saas/src/plugins/css/dark/vanillaSelectBox/custom-vanillaSelectBox.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('saas/src/plugins/css/light/table/datatable/dt-global_style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('saas/src/plugins/css/light/table/datatable/custom_dt_miscellaneous.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('saas/src/plugins/css/dark/table/datatable/dt-global_style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('saas/src/plugins/css/dark/table/datatable/custom_dt_miscellaneous.css')}}">
    ...
    <link href="{{asset('saas/src/assets/css/light/dashboard/dash_1.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('saas/src/assets/css/dark/dashboard/dash_1.css')}}" rel="stylesheet" type="text/css" />
