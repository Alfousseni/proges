...
<header class="page-header">
  ...
  <div class="right-wrapper pull-right">
		<ol class="breadcrumbs">
			...
			<li><a href="#"><span>Lister les commandes en cours</span></a></li>
...
<div class="row">
  ...
  @endif 
 		<header class="panel-heading">
			...
			<h2 class="panel-title">Liste des commandes en cours</h2>
		</header>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center"> 
              ...
              <a href="{{ route('validerC',$commande->num_com)}}" title="Receptionner la commande">
                <i class="fa fa-check"></i> 
              </a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="" title="Modifier la commande">
                <i class="fa fa-edit"></i> 
              </a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="" title="Supprimer la commande">
